...
function Promote() {
 let user=JSON.parse(localStorage.getItem('user'));
  let array=[
    {title:"Promote1",des:"this is the first Promote",image:image1,stock:32,price:35.34,total:66},
    {title:"Promote2",des:"this is the second Promote",image:image2,stock:12,price:32.34,total:46},
    {title:"Promote3",des:"this is the third Promote",image:image3,stock:34,price:55.34,total:363},
    {title:"Promote4",des:"this is the fourth Promote",image:image4,stock:52,price:352.54,total:136},
    {title:"Promote5",des:"this is the fifth Promote",image:image5,stock:72,price:355.34,total:16},
  ]
  return (
    <Stack direction="row" sx={{height:"100vh"}}>
        <Stack sx={{width:"18%"}}><Sidebar tab="promote"/></Stack>
       ...
       <Stack direction="row" sx={{justifyContent:'space-between',alignItems:"center"}}>
          <p className='text-bold'>Product Promote</p>
